...
export default function Shapes(){
    return (
        <div className="row-span-1 row-start-1 -mt-9 aspect-square md:col-span-1 md:col-start-2 md:mt-0">
            <Canvas className="z-0 " shadows gl={{antialias: true}} dpr={[1,1.5]} camera={{position: [0,0,25], fov:30, near: 1, far: 40}}>
...
function Geometries() {
    const geometries = [
        ...
        },
        {
            position: [1.6, 1.6, -5],
            r: 0.3,
            geometry: new THREE.IcosahedronGeometry(1.5) // Gem
        },
        {
            position: [-0.8,-0.75,5],
            r: 0.7,
            geometry: new THREE.CapsuleGeometry(0.4, 1, 2, 16) // Gem
        },
        {
            position:  [1,-0.75,4],
            r: 0.5,
